...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("<code>ᴡᴀɪᴛ ᴀ ᴍɪɴᴜᴛᴇ...</code>", quote=True)
    try:
        ...
        await reply_text.edit_text("<b>ᴀɴ ᴇʀʀᴏʀ ʜᴀꜱ ᴏᴄᴄᴜʀʀᴇᴅ...</b>")
        return
    ...
    await reply_text.edit(
        f"<b>ꜰɪʟᴇ ꜱʜᴀʀɪɴɢ ʟɪɴᴋ ᴄʀᴇᴀᴛᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ 😉 :</b>\n\n{link}",
